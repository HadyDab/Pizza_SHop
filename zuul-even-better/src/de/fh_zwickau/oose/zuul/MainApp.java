...
/**
 * The mainapp of our game. This class is for loading the GUI.
 * 
...
public class MainApp extends Application {
	...
	public void loadGameOverView(GameWorld world,Player player, String roomName, String lookingDirection) {
		try {
			...
			controler.initControler(world,player, roomName, lookingDirection);
